  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
      <div className="p-8 bg-midnight-900 border border-white/10 rounded-2xl max-w-md w-full mx-4 animate-scale-in">
        <h3 className="font-display text-xl font-semibold mb-6">Edit Category</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-finder-500/50 resize-none"
            />
          </div>
